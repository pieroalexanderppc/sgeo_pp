...
class _PoliceInicioViewState extends State<PoliceInicioView> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafetyLayout(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [
          IconButton(icon: const Icon(Icons.sync_rounded), onPressed: _fetchCounters),
        ],
      ),
        ...
        child: _isLoading
            ...
            : ListView(
                ...
                children: [
                  ...
                  _buildCounterCard('Pendientes', _pendientes, Icons.hourglass_empty_rounded, AppTheme.alertAmber, isDark)
                      .animate()
                      .fadeIn(delay: 50.ms, duration: 300.ms)
                      .slideY(begin: 0.05, end: 0),
                  const SizedBox(height: 14),
                  _buildCounterCard('Confirmados hoy', _confirmadosHoy, Icons.check_circle_rounded, AppTheme.successGreen, isDark)
                      .animate()
                      .fadeIn(delay: 100.ms, duration: 300.ms)
                      .slideY(begin: 0.05, end: 0),
                  const SizedBox(height: 14),
                  _buildCounterCard('Rechazados hoy', _rechazadosHoy, Icons.cancel_rounded, AppTheme.alertRed, isDark)
                      .animate()
  ...
  Widget _buildCounterCard(String title, int value, IconData icon, Color color, bool isDark) {
    return SafetyCard(
      accentColor: color,

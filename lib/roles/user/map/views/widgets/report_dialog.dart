...
// Rediseño visual v2: borde del dialog y del campo de descripcion -> borderSubtle,
// foco del campo de descripcion -> accentCyan (antes borderTactical/accentBlue).
...
class _ReportDialogState extends State<ReportDialog> {
  ...
  Future<void> _obtenerDireccionFisica() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data != null && data['address'] != null) {
          ...
          setState(() {
            _direccionDetectada =
                "$calle ${ciudad.isNotEmpty ? ', $ciudad' : ''}".trim();
            if (_direccionDetectada == "Calle desconocida" &&
                data['display_name'] != null) {
              List<String> partes = data['display_name'].toString().split(',');
              _direccionDetectada = partes.isNotEmpty
                  ? partes[0]
    ...
    if (mounted) {
      setState(() {
        _direccionDetectada =
            "Dirección aproximada (Lat: ${widget.latitud.toStringAsFixed(4)})";
        _isLoadingAddress = false;
      });
    }
  }
  ...
  Future<void> _enviarReporte() async {
    ...
    final offsetStr =
        '${offsetHours < 0 ? '-' : '+'}${offsetHours.abs().toString().padLeft(2, '0')}:00';
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      backgroundColor:
          Colors.transparent, // Fondo manejado por el Container interno
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isDark
                        ? AppTheme.bgDeep.withValues(alpha: 0.5)
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (val) {
                            if (val != null) {
                              setState(() {
                                _subTipoSeleccionadoAmigable = val;
                              });
                            }
                          },
                        ),
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            hintText:
                                'Ej: Moto lineal negra, 2 sujetos armados...',
                            hintStyle: TextStyle(
                              color: isDark

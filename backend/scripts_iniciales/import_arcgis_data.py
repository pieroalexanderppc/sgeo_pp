    ...
    for registro in datos_arcgis:
        try:
            ...
            incidente_historico = {
                ...
                "direccion": registro.get("direccion_hecho"),
                "tipo_via": registro.get("tipo_via_hecho"),
                "departamento": registro.get("departamento_hecho"),
                "provincia": registro.get("provincia_hecho"),
                "distrito": registro.get("distrito_hecho"),
                "ubigeo": registro.get("ubigeo_hecho_delito"),
                "fecha_hecho": fecha_hecho,
                "turno": registro.get("turno_hecho"),
                "tipo": registro.get("tipo_hecho"),
                "sub_tipo": registro.get("subtipo_hecho"),
                "modalidad": registro.get("modalidad_hecho"),
